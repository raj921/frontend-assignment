...
export type ActionsSlotType = {
  ...
  /** Variant props */
  smallScreen?: boolean;
  actionsSlotPosition?: CSSProperties["position"];
  actionsSlotTop?: CSSProperties["top"];
  actionsSlotRight?: CSSProperties["right"];
};
...
const ActionsSlot: NextPage<ActionsSlotType> = ({
  ...
  const actionsSlotStyle: CSSProperties = useMemo(() => {
    return {
      position: actionsSlotPosition,
      top: actionsSlotTop,
      right: actionsSlotRight,
    };
  }, [actionsSlotPosition, actionsSlotTop, actionsSlotRight]);
